...
COP_carnot = nodes[1].t/(nodes[1].t-nodes[0].t)
COP_inner = (nodes[1].h-nodes[2].h)/(nodes[1].h-nodes[0].h)
COP_outer = mdot_w*4200*(Tw_out-Tw_in)/a.wc

#print(nodes[2].p)
#attributes = [attr for attr in dir(nodes[2]) if not attr.startswith('__')]
